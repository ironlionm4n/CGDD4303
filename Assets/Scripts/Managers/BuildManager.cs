...
public class BuildManager : MonoBehaviour {
    ...
    [Header("Previews")]
    public Preview plywoodPreview;
    public Preview lumber2x4Preview;
    public Preview lumber2x6Preview;
    public Preview lumber4x4Preview;
